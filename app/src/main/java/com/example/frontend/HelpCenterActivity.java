...
public class HelpCenterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Tiếp tục xử lý FAQs
        faqContainer = faqsView.findViewById(R.id.faq_container); // từ layout_faqs.xml
    ...
    private void addFaqsToLayout(Map<String, List<FAQItem>> faqData) {
        ...
        for (Map.Entry<String, List<FAQItem>> entry : faqData.entrySet()) {
            ...
            for (FAQItem item : entry.getValue()) {
                ...
                faqItemView.findViewById(R.id.faq_question_layout).setOnClickListener(v -> {
                    if (answer.getVisibility() == View.GONE) {
                        answer.setVisibility(View.VISIBLE);
                        toggleIcon.setImageResource(R.mipmap.ic_minus);
                    } else {
                        answer.setVisibility(View.GONE);
                        toggleIcon.setImageResource(R.mipmap.ic_plus);
                    }
                });
    ...
    private void addContactsToLayout(LinearLayout container) {
        ...
        List<ContactItem> contacts = List.of(
                new ContactItem("Customer Service", "090-767-767", R.mipmap.ic_customer_service),
                new ContactItem("Facebook", "facebook.com/reboundpiercing", R.mipmap.ic_facebook),
                new ContactItem("Website", "www.reboundpiericng.vn", R.mipmap.ic_web),
                new ContactItem("WhatsApp", "012-345-6789", R.mipmap.ic_whatsapp),
                new ContactItem("Twitter", "twitter.com/reboundpiercing", R.mipmap.ic_twitter),
                new ContactItem("Instagram", "instagram.com/reboundpiercing", R.mipmap.ic_instagram)
        );
